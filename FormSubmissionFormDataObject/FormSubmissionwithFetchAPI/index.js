...
function handleFormSubmission(e) {
    return __awaiter(this, void 0, void 0, function () {
        var formData, response, result, responseElement, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (responseElement) {
                        responseElement.textContent = "Resource created with ID: ".concat(result.id);
                    }
                    return [3 /*break*/, 5];
                case 4:
                    error_1 = _a.sent();
                    console.log("Error submitting form:", error_1);
                    return [3 /*break*/, 5];
                case 5:
                    loginForm.reset();
                    return [2 /*return*/];
